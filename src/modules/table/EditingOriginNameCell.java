 ...
 */
public class EditingOriginNameCell extends TableCell<CallRecord, String>{
            ...
            if (empty) {
                ...
                for (Object[] temp : people) {
                    if (temp[1].equals("yes")) {
                        ...
                        if (listObject != null) {
//                            System.out.println("A " + listObject.toString());
//                            System.out.println("B " + person.getIdentifier());
                            if (listObject.getOrigin().contains(person.getPhone())) {
